export const HeroText = () => {
    ...
    return (
        <div className="flex flex-col 2xl:space-y-8 lg:items-start md:items-center space-y-8 ">
            <div className="flex flex-col 2xl:space-y-8 2xl:w-full lg:w-full md:space-y-8 md:w-5/6" style={{"font-family": "'Hind', sans-serif"}}>
            ...
            <button onClick={() => window.location.hash = "about"} class="md:w-2/3 bg-transparent hover:bg-blue-300 text-blue-300 hover:text-white py-2 px-8 lg:w-2/6 border border-blue-300 hover:border-transparent rounded text-2xl">
                Biz Kimiz?
            </button>
        </div>
    )

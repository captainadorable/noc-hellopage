...
export const Ekipgrid = () => {
    const Card = (props) => {
        return(
        <a href={props.href}>
            <div className=" rounded-2xl h-[250px] flex flex-col bg-[#4668dc] text-[#f7eee5]  delay-100 duration-100 hover:bg-[#5577f3] transistion ">
                <div className="flex flex-row  w-full p-3 space-x-10 h-3/4">
                    <div className="flex justify-center w-3/6">
                        <img src={props.img} alt="card_image" className=" bg-cover p-2 hover:p-0 transistion hover:rounded-full duration-100 delay-100 opacity-95 hover:opacity-100 rounded-[100px] "/> 
                    </div>  
                ...
                <div className=" flex flex-row items-center space-x-5 p-2 h-1/4 ">
                    <p className="h-1/2 flex items-center w-11/12">{props.text}</p>

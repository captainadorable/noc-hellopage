...
export const TeamCard = ({
  ...
  return (
    <div className="bg-[#fcf3ea] rounded-2xl w-[22rem] lg:w-96 lg:px-12 shadow-xl flex flex-col items-center py-5">
      <div className="pt-12">
        <img
          className="rounded-full border-4 border-[#5065a5] w-48 h-48 overflow-hidden "
      ...
      <div className="text-lg lg:text-xl pt-2 text-[#404040]">Non-Official Company</div>
      <div className="text-lg lg:text-xl pt-2 text-gray-400">{CardDepartment}</div>
      <div className="text-lg text-center px-4 lg:text-left lg:text-xl lg:px-8 pt-6 h-[325px]">{CardDescription}</div>

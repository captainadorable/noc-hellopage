    ...
    const DetailsComponent = ({details}) => {
        return (
            <div className="flex flex-row items-center space-x-2">
                    <img className="self-start " src="images/tick.svg" width="28"></img>
                    <div>{details}</div>
            </div>
        )
    }
    ...
    return (
        <div className={`flex flex-col items-center bg-${CardColor} lg:w-1/5 lg:h-[6-rem] shadow-xl rounded-2xl overflow-visible`}>
            ...
            <div className="flex flex-row items-center space-x-2 pt-8">
                <img src="https://upload.wikimedia.org/wikipedia/commons/a/af/Turkish_lira_symbol_black.svg" width="16" height="16" className="self-start pt-2"></img>
